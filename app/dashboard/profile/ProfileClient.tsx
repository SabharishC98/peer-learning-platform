            ...
            <div className="max-w-2xl">
                ...
                <div className="grid grid-cols-3 gap-4 mt-6">
                    <div className="bg-gray-800 rounded-xl p-4 border border-gray-700 text-center">
                        ...
                        <div className="text-2xl font-bold">{initialUser.skillsCount}</div>
                        <div className="text-sm text-gray-400">Skills Verified</div>
                    </div>
                    <div className="bg-gray-800 rounded-xl p-4 border border-gray-700 text-center">
                        <div className="text-2xl font-bold">{initialUser.sessionsTaught}</div>
                        <div className="text-sm text-gray-400">Sessions Taught</div>
                    </div>
                    <div className="bg-gray-800 rounded-xl p-4 border border-gray-700 text-center">
                        <div className="text-2xl font-bold">{initialUser.sessionsAttended}</div>
